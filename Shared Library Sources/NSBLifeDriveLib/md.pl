...
<title>Tech Note 40: Using the LifeDrive Shared Library</title>
...
<B><FONT FACE="Helvetica" SIZE=5>
      <h2>Tech Note 40: Using the LifeDrive Shared Library</h2>
	  <h3>July 11, 2005<FONT FACE="Helvetica" SIZE=2>
	  </font></h3>
	  </FONT><FONT FACE="Helvetica" SIZE=2>
	  <h5>Copyright 2005 NS BASIC Corporation</h5>
	  </font></B></TD>
</TR>
</TABLE>
<HR>
