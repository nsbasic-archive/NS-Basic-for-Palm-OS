...
//
    ...
    #define CUSTOM_FUNCTION_COUNT   11
...
#define LIBNAME_OFFSET              CUSTOM_FUNCTION_OFFSET(CUSTOM_FUNCTION_COUNT + 1)
    ...
    static MemPtr asm jump_table(void) {
        ...
        CUSTOM_FUNCTION_ENTRY(3)  // THIS_RegisterNotifyEvents 
        CUSTOM_FUNCTION_ENTRY(4)  // THIS_WinGetDisplayExtent 
        CUSTOM_FUNCTION_ENTRY(5)  // THIS_WinSetDisplayExtent 
        CUSTOM_FUNCTION_ENTRY(6)  // THIS_FrmGetDIAPolicy 
        CUSTOM_FUNCTION_ENTRY(7)  // THIS_FrmSetDIAPolicy 
        CUSTOM_FUNCTION_ENTRY(8)  // THIS_PINGetDIAState 
        CUSTOM_FUNCTION_ENTRY(9)  // THIS_PINSetDIAState 
        CUSTOM_FUNCTION_ENTRY(10)  // THIS_PINGetInputTriggerState 
        CUSTOM_FUNCTION_ENTRY(11)  // THIS_PINSetInputTriggerState 
